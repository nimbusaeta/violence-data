...
### Gráfica 1: Total de casos reportados por ciudades en los primeros 5 meses de 2018, 2019 y 2020.
...
fig <- plot_ly(datos2, x = ~CIUDAD, y = ~TOTAL.2018, type = 'bar', name = 'Total 2018')
...
***
Ciudades en las que aumenta el número de casos con respecto a 2019 también con respecto a 2018:
- Álava
- Asturias
- Barcelona
- Castellón
...
### Gráfica 3: Casos reportados por violencia intrafamiliar por año y ciudad
...
*** 
En este mapa se puede observar el número de casos totales de violencia de género reportados por cada una de las capitales de provincia del país. La información que se muestra correspodnde a los meses de enero, febrero, marzo, abril y mayo de 2020.
